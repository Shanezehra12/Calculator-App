...
export default function Mykeyboard () {
  ...
  //When the user press number 

  const handleNumberPress = (buttonValue: string) => {
    if (firstNumber.length < 10) {
      setFirstNumber(firstNumber + buttonValue); //  Eg: 1+2 This becomes 12 not 3 bcx its string
    }
  };

  // When the user press operation
  ...
  const handleOperationPress = (buttonValue: string) => {
    ...
    // When the user clear the screen
